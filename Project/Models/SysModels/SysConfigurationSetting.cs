...
namespace Models.SysModels
{
    ...
    public class UserPointConfiguration
    {
        ...
        //功能模块设置
        #region 账户设置操作奖励积分
        [Required, Display(Name = "设置注册奖励积分"), Range(1, Int32.MaxValue, ErrorMessage = "奖励积分必须大于或等于{1}")]
        public int RegisterPoint { get; set; }

        [Required, MaxLength(200), Display(Name = "注册奖励积分描述")]
        public string RegisterDescription { get; set; }
        [Required,Display(Name = "设置用户名奖励积分"),Range(1,Int32.MaxValue,ErrorMessage = "奖励积分必须大于或等于{1}")]
        ...
        [Required, Display(Name = "设置头像奖励积分"), Range(1, Int32.MaxValue, ErrorMessage = "奖励积分必须大于或等于{1}")]
        ...
        [Required, Display(Name = "绑定邮箱奖励积分"), Range(1, Int32.MaxValue, ErrorMessage = "奖励积分必须大于或等于{1}")]
        public int SetEmailPoint { get; set; }
        [Required, MaxLength(200), Display(Name = "绑定邮箱奖励积分描述")]
        public string SetEmailDescription { get; set; }


        [Required, Display(Name = "绑定手机奖励积分"), Range(1, Int32.MaxValue, ErrorMessage = "奖励积分必须大于或等于{1}")]
        public int SetPhonePoint { get; set; }
        [Required, MaxLength(200), Display(Name = "绑定手机奖励积分描述")]
        public string SetPhoneDescription { get; set; }

        [Required, Display(Name = "设置安全问题奖励积分"), Range(1, Int32.MaxValue, ErrorMessage = "奖励积分必须大于或等于{1}")]
